...
group_CBPs = {}
with open('clade.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    for name in names.keys():
        ...
        if name in ["21", "22", "28", "42", "1393", "1585", "1599", "3", "17", "5", "1593", "43", "25"]:
            writer.writerow([name + "_0"] + subclade_0_list)
            writer.writerow([name + "_1"] + subclade_1_list)
            writer.writerow([name + "_combined"] +subclade_0_list + subclade_1_list)
